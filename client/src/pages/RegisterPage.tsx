...
export default function RegisterForm() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 dark:from-slate-700 dark:to-slate-900">
      <div className="relative w-full max-w-md overflow-hidden rounded-xl bg-white shadow-2xl dark:bg-slate-800 dark:text-slate-200">
        {/* Close Button */}
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full rounded-lg bg-blue-600 px-5 py-2.5 text-center text-sm font-medium text-white hover:cursor-pointer hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:bg-violet-600 dark:hover:bg-violet-700 dark:focus:ring-violet-800"
            >
